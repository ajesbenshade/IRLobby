    ...
    <PublicSiteLayout activePath="/features">
      ...
      <section className="pb-12">
        <div className="mx-auto grid max-w-6xl gap-6 px-6 md:grid-cols-2">
          {featureCards.map((feature) => (
            <article key={feature.title} className="public-glass public-card-hover rounded-[28px] p-8 sm:p-10">
      ...
      <section className="px-6 py-20 text-center">
        <div className="mx-auto max-w-3xl">
          <h2 className="font-display text-4xl font-black text-white sm:text-5xl">See it in action.</h2>
          <a
            href="/download"
