        ...
        <div className="overflow-hidden rounded-[32px] bg-[#f8fafc] text-[#0f172a]">
          ...
          <div className="relative min-h-[690px] px-5 pb-5 pt-8">
            ...
            <div className="relative">
              <p className="text-sm font-extrabold text-[#7c3aed]">For you</p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <span className="rounded-full border border-[#e2e8f0] bg-white/72 px-4 py-2 text-sm font-bold text-[#7c3aed] shadow-sm">
                  Vibe filters
                </span>
                <span className="rounded-full border border-[#e2e8f0] bg-white/72 px-4 py-2 text-sm font-bold text-[#7c3aed] shadow-sm">
                  Map view
            ...
            <div className="relative mt-8 rounded-[30px] bg-[#0f172a] p-4 text-white shadow-[0_26px_60px_rgba(15,23,42,0.18)]">
              <div className="rounded-[24px] bg-gradient-to-br from-[#7c3aed] via-[#ec4899] to-[#22d3ee] p-[1px]">
              ...
              <div className="mt-5 flex items-center justify-center gap-4">
                ...
                <span className="grid h-14 w-14 place-items-center rounded-full bg-[#7c3aed] text-3xl font-light text-white shadow-[0_18px_44px_rgba(124,58,237,0.38)]">
                  +
                </span>
              </div>
            </div>
            ...
            <div className="absolute bottom-5 left-5 right-5 rounded-[28px] border border-[#e2e8f0] bg-white/88 px-4 py-3 shadow-[0_18px_50px_rgba(15,23,42,0.12)] backdrop-blur-xl">
              <div className="grid grid-cols-5 items-end gap-1 text-center text-[11px] font-bold text-[#94a3b8]">
                ...
                <span>Events</span>
                <span className="mx-auto grid h-12 w-12 -translate-y-3 place-items-center rounded-full bg-[#7c3aed] text-3xl font-light text-white shadow-[0_14px_32px_rgba(124,58,237,0.34)]">
                  +
                </span>
                <span>Chat</span>
                <span>Profile</span>
    ...
    <div className="public-site-bg min-h-screen overflow-hidden text-white">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
          <div className="relative z-10">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                href="/download"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[#7c3aed] px-7 py-4 text-base font-black text-white shadow-[0_22px_64px_rgba(124,58,237,0.34)] transition hover:scale-[1.02] hover:bg-[#db2777]"
              >
                Download the app
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <span className="grid h-12 w-12 place-items-center rounded-2xl bg-[#7c3aed]/16 text-[#ec4899]">
      ...
      <section className="px-6 pb-24">
        <div className="mx-auto grid max-w-7xl gap-8 rounded-[36px] border border-white/8 bg-white/5 p-6 shadow-[0_30px_90px_rgba(0,0,0,0.2)] backdrop-blur-xl sm:p-10 lg:grid-cols-[1fr_410px] lg:p-12">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.24em] text-[#ec4899]">
